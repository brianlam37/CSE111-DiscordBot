...
module.exports = {
    ...
    execute(message, args) {
    	let sql  = "SELECT Distinct Ch_Name FROM Class,Champion,InClass WHERE C_Name = ?  AND Champion.Ch_ID = InClass.Ch_ID AND InClass.C_ID = Class.C_ID";
		...
		message.channel.send("Class:").then(()=>{
